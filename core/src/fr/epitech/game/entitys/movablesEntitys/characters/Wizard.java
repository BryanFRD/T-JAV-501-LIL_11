...
public class Wizard extends Character {
    ...
    public Wizard(SpriteBatch batch, World world, String name, Vector2 coordinate, EntityManager entityManager, WaveManager waveManager, EpiGame epiGame) {
        super(batch, world, name, coordinate, new TextureRegion(new Texture("wizard.png")).split(16, 16)[new Random().nextInt(4)], entityManager, waveManager, 0, 100, 100, epiGame);
